...
export type GsmSignalStrengths = import('type-fest').ValueOf<typeof emuMethods.GSM_SIGNAL_STRENGTHS>;
...
declare namespace emuMethods {
     ...
     */
    function sensorSet(sensor: string, value: string | number): Promise<void>;
    /**
     * Emulate power capacity change on the connected emulator.
     *
     * @param {string|number} percent [100] - Percentage value in range [0, 100].
     */
    function powerCapacity(percent?: string | number): Promise<void>;
    /**
     * Emulate power off event on the connected emulator.
     */
    function powerOFF(): Promise<void>;
    /**
     ...
     */
    function sendSMS(phoneNumber: string | number, message?: string): Promise<void>;
    /**
     ...
     */
    function gsmCall(phoneNumber: string | number, action: any): Promise<void>;
    /**
     ...
     */
    function gsmSignal(strength?: 0 | 2 | 1 | 3 | 4): Promise<void>;
    /**
     ...
     */
    function networkSpeed(speed?: any): Promise<void>;
    /**
     ...
     */
    function execEmuConsoleCommand(cmd: string | string[], opts?: ExecTelnetOptions): Promise<string>;
    /**
     ...
     * object is returned
     */
    function getEmuVersionInfo(): Promise<EmuVersionInfo>;
    /**
     ...
     *   target=android-30
     */
    function getEmuImageProperties(avdName: string): Promise<import("@appium/types").StringRecord<any>>;
    /**
     ...
     */
    function checkAvdExist(avdName: string): Promise<boolean>;
}
